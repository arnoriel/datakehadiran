                    ...
                    <div class="card-body">
                        <form action="{{route('jadwal.update',$jadwal->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_siswa" value="{{$jadwal->nama_siswa}}" class="form-control @error('nama_siswa') is-invalid @enderror">
                                @error('nama_siswa')
                            ...
                            <label for="">Masukan Kelas</label>
                                 <select class="form-select" value="{{$jadwal->kelas}}" aria-label="Default select example" name="kelas" id="" >
                            ...
                            <input type="date" name="tgl" value="{{$jadwal->tanggal}}"  class="form-control @error('tgl') is-invalid @enderror" placeholder="Masukkan Tangal">
                            @error('tgl')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                            ...
                            <label for="">Masukkan Data Hadir</label>
                                 <select class="form-select" value="{{$jadwal->hadir}}"  aria-label="Default select example" name="hadir" id="" >
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="izin" value="{{$jadwal->izin}}"  class="form-control @error('izin') is-invalid @enderror" placeholder="Masukkan data Izin beserta Alasannya, jika tidak ada izin ketik --">
                                    @error('izin')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <label for="">Masukkan Data Sakit</label>
                                 <select class="form-select" value="{{$jadwal->sakit}}"  aria-label="Default select example" name="sakit" id="" >
